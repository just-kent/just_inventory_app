sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("justinvapp/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("justinvapp.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["justinvapp/localService/mockserver"], function (mockserver) {
