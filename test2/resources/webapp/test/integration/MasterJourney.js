sap.ui.define([
		...
		opaTest("MasterList Filtering on CC_STOCK_MOV_BAL less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("CC_STOCK_MOV_BAL").
		...
		opaTest("MasterList Filtering on CC_STOCK_MOV_BAL more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 Unit").
				and.iPressOKInViewSelectionDialog();
