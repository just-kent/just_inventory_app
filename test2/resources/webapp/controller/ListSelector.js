sap.ui.define([
		...
		return BaseObject.extend("justinvapp.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias justinvapp.model.ListSelector
			 */
			 ...
			 * @return {justinvapp.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
